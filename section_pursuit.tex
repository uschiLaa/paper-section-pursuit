...
projections for the most interesting slices of the data.
\textcolor{red}{(Technically we are restricting the type of sections considered, defining "slice pursuit" instead, while "section pursuit" covers the general idea and applies to other definitions of sections as well.)}
The ``interestingness'' of each slice is computed as a measure of
