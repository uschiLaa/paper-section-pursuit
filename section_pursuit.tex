...
\author{\name{Ursula Laa$^{a, b}$, Dianne Cook$^{a}$, Andreas Buja$^{c}$, German Valencia$^{b}$}
\affil{$^{a}$Department of Econometrics and Business Statistics, Monash University; $^{b}$School of Physics and Astronomy, Monash University; $^{c}$Statistics Department, The Wharton School, University of Pennsylvania}
}
