...
As $p$ increases, the projected data piles more in the center, for an assumed uniform, or a normal reference distribution. A varying radial bin size can be used to offset this effect, where the bounds of the $K_r$ radial bins take into account the expected distribution of points given $p$. 
