...
This article was created with `knitr` [@knitr] and R Markdown [@rmarkdown] with embedded code, using the `tidyverse` [@tidyverse] packages. We thank the Wharton Statistics department for their hospitality while part of this work was conducted. Open access funding provided by University of Natural Resources and Life Sciences Vienna (BOKU).
